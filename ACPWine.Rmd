...
plot.PCA(acp,axes = c(1,2),choix = "var",title = "Cercle de corrélations",col.hab = rainbow(12),col.quali = "cyan")
###Screeplot
fviz_screeplot(acp,choice="eigenvalue")
fviz_pca_biplot(acp)
###Représentation des variables par cos2
fviz_cos2(acp, choice = "var",axes = c(1))
fviz_cos2(acp, choice = "var",axes = c(2))
fviz_cos2(acp, choice = "var",axes = c(3))
###Représentation des variables par contribution
